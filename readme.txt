...
Contributors: bhargavDholariya
Tags:wpautop, editor, Page editer post editer, excerpt, Formatting, post content, page content remove p tag remove br tag
...
To install "empty p tag" using the built-in plugin installer:
    ...
    2. Type in "remove empty p tag" in Search Plugins.
